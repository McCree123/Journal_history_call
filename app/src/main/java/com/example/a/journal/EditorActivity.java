...
public class EditorActivity extends AppCompatActivity {
    ...
    private EditText mGuestHowlong;
    private EditText mGuestPrice;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mGuestHowlong = (EditText) findViewById(R.id.edit_guest_howlong);
        mGuestPrice = (EditText) findViewById(R.id.edit_guest_price);
    }
    ...
    private void insertPerson() {
        ...
        String howlong = mGuestHowlong.getText().toString();
        String price = mGuestPrice.getText().toString();
        ...
        values.put(JournalContract.GuestEntry.COLUMN_HOWLONG, howlong);
        values.put(JournalContract.GuestEntry.COLUMN_PRICE, price);
