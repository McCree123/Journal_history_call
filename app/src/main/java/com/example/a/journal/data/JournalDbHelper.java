...
public class JournalDbHelper extends SQLiteOpenHelper {
     ...
     */
    private static final String DATABASE_NAME = "journal_histoty_call.db";
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String SQL_CREATE_GUESTS_TABLE = "CREATE TABLE " + JournalContract.GuestEntry.TABLE_NAME + " ("
                ...
                + JournalContract.GuestEntry.COLUMN_HOWLONG + " TEXT NOT NULL, "
                + JournalContract.GuestEntry.COLUMN_PRICE + " TEXT NOT NULL);";
