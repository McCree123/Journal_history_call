...
//                        .setAction("Action", null).show();
    ...
    private void displayDatabaseInfo() {
        ...
        String[] projection = {
                ...
                JournalContract.GuestEntry.COLUMN_HOWLONG,
                JournalContract.GuestEntry.COLUMN_PRICE,
        };
        ...
        try {
            ...
            int howlongColumnIndex = cursor.getColumnIndex(JournalContract.GuestEntry.COLUMN_HOWLONG);
            int priceColumnIndex = cursor.getColumnIndex(JournalContract.GuestEntry.COLUMN_PRICE);
            ...
            while (cursor.moveToNext()) {
                ...
                String currentHowlong = cursor.getString(howlongColumnIndex);
    ...
    private void insertPerson() {
        ...
        values.put(JournalContract.GuestEntry.COLUMN_PATH_TO_PHOTO, "content://lalala/65749");
        ...
        values.put(JournalContract.GuestEntry.COLUMN_HOWLONG, "153");
        values.put(JournalContract.GuestEntry.COLUMN_PRICE, "24");
